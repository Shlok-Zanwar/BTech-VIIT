...
public class SuffixTree {
    ...
    private String markPatternInText(Integer startPosition, String pattern) {
        ...
        return matchingTextLHS + "\033[1m\u001B[33m" + matchingText + "\033[0m" + matchingTextRHS;
    }
    ...
    public static void main(String[] args) {
        ...
        SuffixTree suffixTree = new SuffixTree("havanabanana abcabanana rishishrimali shrimali");
        //List<String> matches = suffixTree.searchText("banana");
        System.out.println("Enter the word you want to search");
        String to_Find = cin.nextLine();
        List<String> matches = suffixTree.searchText(to_Find);
